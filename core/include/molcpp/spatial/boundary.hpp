 ...
 */
class MOLCPP_EXPORT FreeBoundary : public Boundary {
public:
 ...
 */
class MOLCPP_EXPORT OrthogonalBoundary : public Boundary {
public:
    /**
 ...
 */
class MOLCPP_EXPORT TriclinicBoundary : public Boundary {
public:
    /**
 ...
 */
class MOLCPP_EXPORT SphericalBoundary : public Boundary {
public:
    /**
